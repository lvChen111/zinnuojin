            ...
            case 'enable':
                try {
                    ...
                    if (!$force) {
                        ...
                        $output->info("Are you sure you want to " . ($action == 'enable' ? 'override' : 'delete') . " all those files?  Special 'yes' to continue: ");
            ...
            case 'install':
                ...
                try {
                    ...
                    if (!$force) {
                        ...
                        $output->info("Are you sure you want to override all those files?  Special 'yes' to continue: ");
                        $line = fgets(defined('STDIN') ? STDIN : fopen('php://stdin', 'r'));
                        if (trim($line) != 'yes') {
                            throw new Exception("Operation is aborted!");
                        }
            ...
            case 'uninstall':
                ...
                try {
                    ...
                    if (!$force) {
                        ...
                        $output->info("Are you sure you want to delete all those files?  Special 'yes' to continue: ");
                        $line = fgets(defined('STDIN') ? STDIN : fopen('php://stdin', 'r'));
                        if (trim($line) != 'yes') {
                            throw new Exception("Operation is aborted!");
                        }
