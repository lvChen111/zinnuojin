...
{
    protected $appid='wx83bc403fbbedb891';// 商户账号appid
    protected $mchid='1604954536';// 商户号
    protected $secrect_key='Qxxy12345678900987654321QxxyQxxy';// 支付密钥签名
    /**
     ...
     * @param  [type] $trade_no  [提现单号]
     * @param  string $desc       [企业付款描述信息 (必填)]
     * @param  string $check_name [收款用户姓名 (选填)]
     * @return [type]             [description]
     */
    public function sendMoney($amount,$re_openid,$trade_no,$desc='提现',$check_name=''){
        ...
        $data=array(
            ...
            'desc'=> $desc,//企业付款描述信息
            'spbill_create_ip'=> '39.99.253.149',//Ip地址
        );
