...
class MathTrig
{
     ...
     * POWER.
     *
     * Computes x raised to the member y.
     *
     * @param float $x
     * @param float $y
     *
     ...
     * SERIESSUM.
     *
     * Returns the sum of a member series
     *
     * @param float $x Input value to the member series
     * @param float $n Initial member to which you want to raise $x
