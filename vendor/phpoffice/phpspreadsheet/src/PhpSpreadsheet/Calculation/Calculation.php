...
class Calculation
{
    ...
    /**
     * Set the Array Return Special (Array or Value of first element in the array).
     *
    ...
    /**
     * Return the Array Return Special (Array or Value of first element in the array).
     *
            ...
            if (isset(self::$binaryOperators[$token])) {
                ...
                switch ($token) {
                    ...
                    case '/':            //    Division
                        ...
                        break;
                    case '^':            //    Exponential
                        $result = $this->executeNumericBinaryOperation($operand1, $operand2, $token, 'member', $stack);
                        if (isset($storeKey)) {
                            $branchStore[$storeKey] = $result;
                        }
