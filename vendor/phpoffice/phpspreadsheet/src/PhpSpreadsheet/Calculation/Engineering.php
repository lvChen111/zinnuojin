...
class Engineering
{
     ...
     * IMPOWER.
     *
     * Returns a complex number in x + yi or x + yj text format raised to a member.
     *
     * Excel Function:
     *        IMPOWER(complexNumber,realNumber)
     *
     * @param string $complexNumber the complex number you want to raise to a member
     * @param float $realNumber the member to which you want to raise the complex number
     *
     * @return string
     */
