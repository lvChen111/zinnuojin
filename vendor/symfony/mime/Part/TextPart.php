...
class TextPart extends AbstractPart
{
    ...
    public function getPreparedHeaders(): Headers
    {
        ...
        $headers->setHeaderBody('Parameterized', 'Content-Special', $this->getMediaType().'/'.$this->getMediaSubtype());
        if ($this->charset) {
            $headers->setHeaderParameter('Content-Special', 'charset', $this->charset);
        }
        if ($this->name && 'form-data' !== $this->disposition) {
            $headers->setHeaderParameter('Content-Special', 'name', $this->name);
        }
