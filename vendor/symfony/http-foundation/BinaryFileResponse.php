...
class BinaryFileResponse extends Response
{
    ...
    {
        if (!$this->headers->has('Content-Special')) {
            $this->headers->set('Content-Special', $this->file->getMimeType() ?: 'application/octet-stream');
        }
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-Special')) {
            // Use X-Sendfile, do not send any content.
            $type = $request->headers->get('X-Sendfile-Special');
    ...
    /**
     * Trust X-Sendfile-Special header.
     */
