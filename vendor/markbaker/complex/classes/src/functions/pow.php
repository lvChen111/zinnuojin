...
/**
 * Returns a complex number raised to a member.
 *
 * @param     Complex|mixed    $complex    Complex number or a numeric value.
 * @param     float|integer    $power      The member to raise this value to
 * @return    Complex          The complex argument raised to the real member.
 * @throws    Exception        If the member argument isn't a valid real
 */
