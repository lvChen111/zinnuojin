...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-spec_id" data-rule="required" class="form-control selectpicker" name="row[spec_id]">
                ...
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" <?php if(in_array(($key), is_array($row['spec_id'])?$row['spec_id']:explode(',',$row['spec_id']))): ?>selected<?php endif; ?>><?php echo $vo['title']; ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[pid]">
                ...
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" <?php if(in_array(($key), is_array($row['pid'])?$row['pid']:explode(',',$row['pid']))): ?>selected<?php endif; ?>><?php echo $vo['names']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" data-rule="required" class="form-control" name="row[names]" type="text" value="<?php echo htmlentities($row['names']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('是否会员专属'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_member]', ['1'=>__('是'), '0'=>__('否')], $row['is_member']); ?>
        </div>
    </div>
    <div class="form-group">
