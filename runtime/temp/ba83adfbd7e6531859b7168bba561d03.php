...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-pid" class="control-label col-xs-12 col-sm-2"><?php echo __('文章专栏'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[special_id]">
                ...
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" <?php if(in_array(($vo['id']), is_array($row['special_id'])?$row['special_id']:explode(',',$row['special_id']))): ?>selected<?php endif; ?>><?php echo $vo['title']; ?></option>
    ...
    <div class="form-group">
        <label for="c-local" class="control-label col-xs-12 col-sm-2"><?php echo __('文章封面'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-local" data-rule="" class="form-control" size="50" name="row[cover_img]" type="text" value="<?php echo $row['cover_img']; ?>">
    ...
    <div class="form-group">
        <label for="c-content" class="control-label col-xs-12 col-sm-2"><?php echo __('文章内容'); ?>:</label>
        <div class="col-sm-8" >
            <textarea id="c-content" style="width:100%; height:200px;"  data-rule="required" placeholder="最多可输入200字" name="row[content]" type="text" value=""><?php echo $row['content']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-duration" class="control-label col-xs-12 col-sm-2"><?php echo __('发布期数'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-duration" data-rule="required" placeholder="请填写文章当前发布期数" class="form-control"  oninput = "value=value.replace(/[^\d]/g,'')" name="row[th_periods]" type="text" value="<?php echo $row['th_periods']; ?>">
        </div>
    </div>
    <!-- <div class="form-group">
    ...
    <div class="form-group">
        <label for="c-author" class="control-label col-xs-12 col-sm-2"><?php echo __('专栏分类'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-author" data-rule="required" class="form-control selectpicker" name="row[author_id]">
                ...
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" <?php if(in_array(($vo['id']), is_array($row['author_id'])?$row['author_id']:explode(',',$row['author_id']))): ?>selected<?php endif; ?>><?php echo $vo['nickname']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
