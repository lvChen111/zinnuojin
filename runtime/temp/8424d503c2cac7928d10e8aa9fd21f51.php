...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-name" class="control-label col-xs-12 col-sm-2"><?php echo __('会员权益名称'); ?>:</label>
    ...
    <div class="form-group">
        <label for="c-cover" class="control-label col-xs-12 col-sm-2">Logo:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-cover" data-rule="" class="form-control" size="50" name="row[logo_img]" type="text" value="<?php echo $row['logo_img']; ?>">
