...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-local" data-rule="" class="form-control" size="50" name="row[cover]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-thumb" class="form-control" size="50" name="row[banner]" type="text" value="" />
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8" >
            <textarea id="c-content" style="width:100%; height:200px;"  data-rule="required" placeholder="最多可输入200字" name="row[synopsis]" type="text" value=""></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-duration" class="control-label col-xs-12 col-sm-2"><?php echo __('专栏期数'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-duration" data-rule="required" placeholder="请填写专栏预计发布期数" class="form-control"  oninput = "value=value.replace(/[^\d]/g,'')" name="row[all_periods]" type="text" value="">
        </div>
    </div>
   <!-- <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_charge]', [ '1'=>__('会员免费'),'2'=>__('全部免费'),'3'=>_('全部收费')]); ?>
        </div>
    </div>
    <div class="form-group">
