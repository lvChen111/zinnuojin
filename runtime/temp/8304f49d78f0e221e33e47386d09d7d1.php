                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo $totalcategory; ?></span>
                                <?php echo __('Total category'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="panel bg-blue-gradient no-border">
                            <div class="panel-body">
                                ...
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h1 class="no-margins"><?php echo $totalcategory; ?></h1>
