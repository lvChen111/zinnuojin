...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-local" data-rule="" class="form-control" size="50" name="row[cover_img]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8" >
            <textarea id="c-content" style="width:100%; height:200px;"  data-rule="required" placeholder="最多可输入200字" name="row[content]" type="text" value=""></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-duration" class="control-label col-xs-12 col-sm-2"><?php echo __('发布期数'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-duration" data-rule="required" placeholder="请填写文章当前发布期数" class="form-control"  oninput = "value=value.replace(/[^\d]/g,'')" name="row[th_periods]" type="text" value="">
        </div>
    </div>
   <!-- <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-author" data-rule="required" class="form-control selectpicker" name="row[author_id]">
                ...
                <option data-type="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" <?php if(in_array(($key), explode(',',""))): ?>selected<?php endif; ?>><?php echo $vo['nickname']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
