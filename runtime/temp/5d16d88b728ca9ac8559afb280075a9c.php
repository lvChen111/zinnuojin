    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-cover" data-rule="" class="form-control" size="50" name="row[logo_img]" type="text" value="">
