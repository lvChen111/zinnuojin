...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-name" class="control-label col-xs-12 col-sm-2"><?php echo __('笔名昵称'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" data-rule="required" class="form-control" name="row[nickname]" type="text" value="<?php echo $row['nickname']; ?>">
        </div>
    </div>
    <div class="form-group">
