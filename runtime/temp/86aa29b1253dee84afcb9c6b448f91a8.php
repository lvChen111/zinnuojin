                ...
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <!-- <div class="dropdown btn-group <?php echo $auth->check('user/user/multi')?'':'hide'; ?>">
                             &lt;!&ndash;<a class="btn btn-primary btn-more dropdown-toggle btn-disabled disabled" data-toggle="dropdown"><i class="fa fa-cog"></i> <?php echo __('More'); ?></a>&ndash;&gt;
                            &lt;!&ndash; <ul class="dropdown-menu text-left" role="menu">
