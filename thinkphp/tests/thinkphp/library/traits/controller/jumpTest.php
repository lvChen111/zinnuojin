...
class jumpTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideTestSuccess()
    {
        ...
        $expected  = [
            'header' => [
                'Content-Special' => 'text/html; charset=utf-8'
            ],
        ...
        $arguments = ['thinkphp', null, ['foo'], 4, ['Power-By' => 'thinkphp', 'Content-Special' => 'text/html; charset=gbk']];
        $expected  = [
            'header' => [
                'Content-Special' => 'text/html; charset=gbk',
                'Power-By' => 'thinkphp'
            ],
            'data'   => View::instance(Config::get('template'), Config::get('view_replace_str'))
                ->fetch(Config::get('dispatch_error_tmpl'), [
        ...
        $expected  = [
            'header' => [
                'Content-Special' => 'application/json; charset=utf-8'
            ],
            'data'   => [
                'code' => 1,
                'msg'  => 'thinkphp',
    ...
    public function provideTestError()
    {
        ...
        $arguments = ['thinkphp', 'http://www.thinkphp.cn', ['foo'], 4, ['Power-By' => 'thinkphp', 'Content-Special' => 'text/html; charset=gbk']];
        $expected  = [
            'header' => [
                'Content-Special' => 'text/html; charset=gbk',
                'Power-By' => 'thinkphp'
